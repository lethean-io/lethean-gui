...
; See LICENSE
#define GuiVersion GetFileVersion("bin\lethean-wallet-gui.exe")
...
Source: "bin\lethean-wallet-gui.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\lethean-gui-wallet-guide.pdf"; DestDir: "{app}"; Flags: ignoreversion

; Monero CLI wallet
Source: "bin\extras\lethean-wallet-cli.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\lethean-gen-trusted-multisig.exe"; DestDir: "{app}"; Flags: ignoreversion

; Monero wallet RPC interface implementation
Source: "bin\extras\lethean-wallet-rpc.exe"; DestDir: "{app}"; Flags: ignoreversion

; Monero daemon
Source: "bin\letheand.exe"; DestDir: "{app}"; Flags: ignoreversion

; Monero daemon wrapped in a batch file that stops before the text window closes, to see any error messages
Source: "lethean-daemon.bat"; DestDir: "{app}"; Flags: ignoreversion;

; Monero blockchain utilities
Source: "bin\extras\lethean-blockchain-export.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\lethean-blockchain-import.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\lethean-blockchain-mark-spent-outputs.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\lethean-blockchain-usage.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\lethean-blockchain-import.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\lethean-blockchain-ancestry.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\lethean-blockchain-depth.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\lethean-blockchain-prune-known-spent-data.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\lethean-blockchain-prune.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\lethean-blockchain-stats.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\lethean-gen-ssl-cert.exe"; DestDir: "{app}"; Flags: ignoreversion
...
begin
  ...
  blockChainDefaultDir := ExpandConstant('{commonappdata}\bitlethean');
  ...
  RegQueryStringValue(HKEY_CURRENT_USER, 'Software\lethean\lethean-core', 'blockchainDataDir', blockChainDir);
...
begin
  Result := BlockChainDir('') + '\bitlethean.log';
...
Name: "{group}\GUI Wallet Guide"; Filename: "{app}\lethean-gui-wallet-guide.pdf"; IconFilename: "{app}\lethean-wallet-gui.exe"
...
Name: "{group}\Utilities\Monero Daemon"; Filename: "{app}\letheand.exe"; Parameters: {code:DaemonFlags}
...
Name: "{group}\Utilities\Textual (CLI) Wallet"; Filename: "{app}\lethean-wallet-cli.exe"; WorkingDir: "{userdocs}\Monero\wallets"
...
Name: "{group}\Utilities\x (Check GUI Wallet Log)"; Filename: "Notepad"; Parameters: """{userappdata}\lethean-wallet-gui\lethean-wallet-gui.log"""
...
Name: "{commondesktop}\GUI Wallet"; Filename: "{app}\lethean-wallet-gui.exe"; Tasks: desktopicon
...
Root: HKCU; Subkey: "Software\lethean"; Flags: uninsdeletekeyifempty
Root: HKCU; Subkey: "Software\lethean\lethean-core"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\lethean\lethean-core"; ValueType: string; ValueName: "blockchainDataDir"; ValueData: {code:BlockChainDirOrEmpty};

; Configure a custom URI scheme: Links starting with "lethean:" will start the GUI wallet exe with the URI as command-line parameter
; Used to easily start payments; example URI: "lethean://<address>?tx_amount=5.0"
Root: HKCR; Subkey: "lethean"; ValueType: "string"; ValueData: "URL:Monero Payment Protocol"; Flags: uninsdeletekey
Root: HKCR; Subkey: "lethean"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCR; Subkey: "lethean\DefaultIcon"; ValueType: "string"; ValueData: "{app}\lethean-wallet-gui.exe,0"
Root: HKCR; Subkey: "lethean\shell\open\command"; ValueType: "string"; ValueData: """{app}\lethean-wallet-gui.exe"" ""%1"""

; Configure a custom URI scheme: Links starting with "letheanseed:" will start the GUI wallet exe with the URI as command-line parameter
; Used to easily hand over custom seed node info to the wallet, with an URI of the form "letheanseed://a.b.c.d:port"
Root: HKCR; Subkey: "letheanseed"; ValueType: "string"; ValueData: "URL:Monero Seed Node Protocol"; Flags: uninsdeletekey
Root: HKCR; Subkey: "letheanseed"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCR; Subkey: "letheanseed\DefaultIcon"; ValueType: "string"; ValueData: "{app}\lethean-wallet-gui.exe,0"
Root: HKCR; Subkey: "letheanseed\shell\open\command"; ValueType: "string"; ValueData: """{app}\lethean-wallet-gui.exe"" ""%1"""
